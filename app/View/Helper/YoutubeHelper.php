 ...
 ******* 
 *******
 	CUSTOMIZED BY DUSTIN: 
 	- added 'id' to player_variables and setup 'enablejsapi' and 'playerapiid' in player_settings and added 'id' to $this->tag('object'… 
 	- these will all help with the API usage and identifying a particular player on a page with several players
 *******
 *******
 ...
 USEAGE:
	...
	To embed a video 
	<?= $this->Youtube->video('YOUTUBE_URL_OR_VIDEO_ID', array $player_settings, array $player_variables); ?> 

	To get images/thumbnails from a video 
	<?= $this->Youtube->thumbnail('YOUTUBE_URL_OR_VIDEO_ID'); ?> 
...
*/ 
    ...
    class YoutubeHelper extends HtmlHelper { 
        ...
        var $player_settings = array( 
            ...
            'enablejsapi' => 1,    // Enables YouTube API
            'playerapiid' => 'ytplayer' //Sets ID for the video
        ); 
